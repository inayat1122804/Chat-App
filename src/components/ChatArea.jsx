...
const ChatArea = ({ selectedGroup, socket, setSelectedGroup }) => {
  ...
  const fetchMessages = async () => {
    ...
    try {
      ...
      // keep messages in chronological order (oldest -> newest)
            ...
            >
              {messages.map((message) => {
                ...
                return (
                  <Box
                    key={message._id}
                    alignSelf={isSentByMe ? "flex-start" : "flex-end"}
                    maxW="70%"
                  >
                    <Flex direction="column" gap={1}>
                      <Flex
                        align="center"
                        mb={1}
                        justifyContent={isSentByMe ? "flex-start" : "flex-end"}
                        gap={2}
                      >
                        {isSentByMe ? (
                          <>
